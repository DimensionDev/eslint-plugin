...
import jsx$no_template_literal from './rules/jsx/no-template-literal.js'
import jsx$no_unneeded_nested from './rules/jsx/no-unneeded-nested.js'
import jsx$prefer_test_id from './rules/jsx/prefer-test-id.js'
import string$no_data_url from './rules/string/no-data-url.js'
import string$no_interpolation from './rules/string/no-interpolation.js'
...
import type$no_instanceof_wrapper from './rules/type/no-instanceof-wrapper.js'
import type$no_number_constructor from './rules/type/no-number-constructor.js'
import type$no_wrapper_type_reference from './rules/type/no-wrapper-type-reference.js'
import type$prefer_return_type_annotation from './rules/type/prefer-return-type-annotation.js'
...
import no_redundant_variable from './rules/no-redundant-variable.js'
import no_single_return from './rules/no-single-return.js'
import no_then from './rules/no-then.js'
